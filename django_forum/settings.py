...
cloudinary.config(
  cloud_name = "dibe9m6xm",
  api_key = "768193551283688",
  api_secret = "YaAKfydLbrLGnm-sUXUfxgvevms",
  secure = True
)
...
SECRET_KEY = 'django-insecure-z_go)$g%@+z#wppthhgq$r)kua1ghpg%i(aw(b8=w&#3n#or&n'
